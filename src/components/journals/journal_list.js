...
const rawJournalData = [
    ...
    { title: "--Maid--", content: <h2>"Why did a fellow student say that I should blur out my background because he can see my house cleaner in the background, ha. No maid, just my <u>wife</u> who is from <i>Vera Cruz, Mexico.</i>"</h2>, status: "draft" },
